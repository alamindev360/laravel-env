...
namespace AlaminDev360\SetEnv\Commands;

use Illuminate\Console\Command;
use Illuminate\Console\ConfirmableTrait;
use AlaminDev360\SetEnv\Facades\Env;
...
class SetEnvCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'alamindev360:set-env {new_env_var?} {--E|env_file=.env : Environment file} {--force : Force running in production}';
